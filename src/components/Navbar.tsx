    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div>
          <Link
            href="#"
            className="group inline-flex items-center gap-2 rounded-full bg-brand-navy px-5 py-2.5 text-[14px] font-semibold text-white transition-all duration-300 hover:bg-brand-navy-light hover:shadow-premium"
          >
            Let's Talk
